 ...
 * @author LENOVO
 */
public class PenilaianSiswa_Bing extends javax.swing.JFrame {


    /**
     * Creates new form input_data
     */
    public PenilaianSiswa_Bing() {
        initComponents();
        KosongForm();
        TampilData();
    }
    ...
    public void TampilData() {
        ...
        try {
            int no = 1;
            String sql = "SELECT * FROM penilaiansiswa_bing";
    ...
    private void initComponents() {
        ...
        jLabel1.setText("PENILAIAN BAHASA INGGRIS [NUMBER]");
    ...
    private void simpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_simpanActionPerformed
        // TODO add your handling code here:
        try {
            String sql = "INSERT INTO penilaiansiswa_bing VALUES ('"+nisn.getText()+"', '"+nama.getText()+"', '"+kelas.getText()+"', '"+nilai.getText()+"')";
            java.sql.Connection conn = (Connection) konfig.configDB();
    ...
    private void tabelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelMouseClicked
        ...
        kelas.setText(Kelas);
        String Soal1 = tabel.getValueAt(baris, 4).toString();
        nilai.setText(Soal1);
    ...
    private void editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editActionPerformed
        // TODO add your handling code here:
        try {
            String sql = "UPDATE penilaiansiswa_bing SET nisn='" + nisn.getText() + "'nama='" + nama.getText() + "',kelas='" + kelas.getText() + "',NILAI='" + nilai.getText() + "'";
            java.sql.Connection conn = (Connection) konfig.configDB();
            java.sql.PreparedStatement pstm = conn.prepareStatement(sql);
            pstm.execute();
    ...
    private void hapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hapusActionPerformed
        // TODO add your handling code here:
        try {
            String sql = "DELETE FROM penilaiansiswa_bing WHERE nisn='" + nisn.getText() + "'";
            java.sql.Connection conn = (Connection) konfig.configDB();
            java.sql.PreparedStatement pstm = conn.prepareStatement(sql);
            pstm.execute();
    ...
    private void btnCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCetakActionPerformed
        // TODO add your handling code here:
        try {
            InputStream is = PenilaianSiswa_Bing.class.getResourceAsStream("/Laporan/PenilaianSiswa_Bing.jasper");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PenilaianSiswa_Bing.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
